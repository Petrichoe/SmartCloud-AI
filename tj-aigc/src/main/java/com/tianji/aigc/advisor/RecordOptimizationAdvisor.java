...
public class RecordOptimizationAdvisor implements CallAroundAdvisor, StreamAroundAdvisor {
    ...
    private final HybridChatMemory hybridChatMemory;

    public RecordOptimizationAdvisor(HybridChatMemory hybridChatMemory) {
        this.hybridChatMemory = hybridChatMemory;
    }
    ...
    public AdvisedResponse aroundCall(AdvisedRequest advisedRequest, CallAroundAdvisorChain chain) {
        ...
        if (null != agentTypeEnum) {
            ...
            this.hybridChatMemory.optimization(conversationId);
        }
